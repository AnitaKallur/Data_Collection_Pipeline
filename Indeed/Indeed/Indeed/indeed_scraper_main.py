...
class Scraper:
    ...
    def nevigate_page(self) -> None:
        ...
        for i in range(5):
            ...
            df.to_csv(r'/Users/prabhuswamikallur/Desktop/Data_Collection_Pipeline/Indeed_jobs_.csv', 
            index = False, header=True)
            print(df)
            

            if os.path.exists(f'{save_path}/Indeed_jobs_Dataframe/dataframe_Indeed_jobs.csv') and os.path.exists(f'{save_path}/IMDB_Dataframe/IMDB_TV.json'):
